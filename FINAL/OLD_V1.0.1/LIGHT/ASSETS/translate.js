...
const strings = {
    'EN': {
        ...
        'CREDITS_SLIDE13': '{center}{yellow-fg}BETA TESTERS{/yellow-fg}\n\n{bold}{testers}{/bold}{/center}',
...
'LUX_L_ACHIEVEMENT_TOAST': '{center}{yellow-fg}{bold}ACHIEVEMENT UNLOCKED{/}\n{white-fg}{name}{/center}',
    ...
    'PT': {
        ...
        'ACHIEVEMENT_REBEL_PATH_DESC': 'Usou o código de sobreposição administrativa.',
        'ACHIEVEMENT_REBEL_PATH_HINT': 'Digite um código alternativo no terminal de login do escritório.',
        ...
        'ACHIEVEMENT_NEW_GOD_DESC': 'Fundiu-se com o núcleo e tornou-se um com a rede.',
        ...
        'ACHIEVEMENT_LEAK_SAVED_HINT': 'Pressione [S] durante a sequência de vazamento de dados.',
        ...
        'ACHIEVEMENT_AUDIOPHOBIC_HINT': 'Pressione [M] cinco vezes para mutar o áudio.',
        
        'ACHIEVEMENT_COLOR_MASTER_NAME': 'ANALISTA ESPECTRAL',
        'ACHIEVEMENT_COLOR_MASTER_DESC': 'Alternou entre todas as cores do sistema repetidamente.',
        ...
        'ACHIEVEMENT_DATA_MINER_DESC': 'Acessou informações do sistema obsessivamente.',
        ...
        'CHECKPOINT_HEADER': '{center}{bold}PONTOS DE VERIFICAÇÃO: {current}/{total}{/center}',
        'CHECKPOINT_REACHED': '{center}{green-fg}{bold}[X] {name}{/}\n\n{white-fg}{desc}{/center}',
        ...
        'CREDITS_SLIDE7': '{center}{yellow-fg}DESIGN DE NÍVEIS{/yellow-fg}\n\n{bold}{name}{/bold}{/center}',
        'CREDITS_SLIDE8': '{center}{yellow-fg}DESIGN NARRATIVO{/yellow-fg}\n\n{bold}{name}{/bold}{/center}',
...
'MAIN_ELITE_DATA': "{yellow-fg}[DADOS DE ELITE DESBLOQUEADOS]: PROJECT FADE - PRELÚDIO PARA 1999.{/yellow-fg}",
...
'MAIN_OFFICE_SCENE2': "[CAOS]: Colegas de trabalho estão correndo em círculos, alguns rezando, outros quebrando monitores.",
