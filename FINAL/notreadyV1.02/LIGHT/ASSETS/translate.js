...
const strings = {
  EN: {
    ...
    MENU_TOP_SECRET: "{center}[TOP_SECRET]{/center}",
    ...
    ACCOUNT_ONLINE:
      "{bold}ACCOUNT STATUS: {green-fg}ONLINE (@{username}){/green-fg}{/bold}",
    ...
    ACHIEVEMENT_TOAST:
      "{center}{yellow-fg}{bold}FRAGMENT ACQUIRED{/}\n{white-fg}{name}{/center}",
    ...
    ACHIEVEMENTS_LOCKED:
      "{center}{white-fg}[ ] CORRUPTED{/}\n\n{white-fg}DATA LOCKED{/center}",
    ACHIEVEMENTS_UNLOCKED:
      "{center}{green-fg}{bold}[X] {name}{/}\n\n{white-fg}{desc}{/center}",
    ...
    ACHIEVEMENT_REBEL_PATH_HINT:
      "Input an alternative code in the office login terminal.",
    ...
    ACHIEVEMENT_RADIO_LISTENER_HINT:
      "Choose to listen to the radio in the elevator.",

    ACHIEVEMENT_GHOST_GUARDIAN_NAME: "DIGITAL SHEPHERD",
    ACHIEVEMENT_GHOST_GUARDIAN_DESC: "Chose to protect the trapped souls.",
    ACHIEVEMENT_GHOST_GUARDIAN_HINT:
      "Choose to protect the souls in the final core.",

    ACHIEVEMENT_NEW_GOD_NAME: "ELECTRONIC ASCENSION",
    ACHIEVEMENT_NEW_GOD_DESC:
      "Merged with the core and became one with the grid.",
    ACHIEVEMENT_NEW_GOD_HINT:
      "Choose to merge with the Fade in the final choice.",

    ACHIEVEMENT_SHADOW_FALL_NAME: "CORE MELTDOWN",
    ACHIEVEMENT_SHADOW_FALL_DESC: "Failed to stabilize the core.",
    ACHIEVEMENT_SHADOW_FALL_HINT:
      "Fail to maintain the balance during the final sequence.",
    ...
    ACHIEVEMENT_COLOR_MASTER_DESC:
      "Cycled through all system colors repeatedly.",
    ...
    ACHIEVEMENT_TERMINAL_JUNKIE_HINT:
      "Enter and exit the achievements screen five times.",

    ACHIEVEMENT_HARD_RESET_NAME: "FRESH START",
    ACHIEVEMENT_HARD_RESET_DESC: "Reset all configurations to default.",
    ACHIEVEMENT_HARD_RESET_HINT:
      "Use the Reset to Defaults option in Settings.",
    ...
    UPDATE_SECTOR:
      "{center}{grey-fg}{bold}Sector {current} of {total} | Synchronizing: {file}{/bold}{/grey-fg}{/center}",
    UPDATE_COMPLETE_MSG:
      "{center}{bold}UPDATE SEQUENCE COMPLETE{/bold}{/center}",
    UPDATE_COMPLETE:
    ...
    CHECKPOINT_HEADER:
      "{center}{bold}CHECKPOINT STATUS: {current}/{total}{/center}",
    CHECKPOINT_REACHED:
      "{center}{green-fg}{bold}[X] {name}{/}\n\n{white-fg}{desc}{/center}",
    CHECKPOINT_LOCKED:
    ...
    CREDITS_SLIDE4:
      "{center}{yellow-fg}LEAD PROGRAMMER{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE5:
      "{center}{yellow-fg}SYSTEM ARCHITECT{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE6:
      "{center}{yellow-fg}VISUAL DESIGN{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE7:
      "{center}{yellow-fg}LEVEL DESIGN{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE8:
      "{center}{yellow-fg}NARRATIVE DESIGN{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE9:
      "{center}{yellow-fg}AUDIO ENGINEERING{/yellow-fg}\n\n{bold}{names}{/bold}{/center}",
    CREDITS_SLIDE10:
      "{center}{yellow-fg}QUALITY ASSURANCE{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE11:
      "{center}{yellow-fg}ENDING THEME{/yellow-fg}\n\n{bold}{theme}{/bold}{/center}",
    CREDITS_SLIDE12:
      "{center}{yellow-fg}PUBLISHER{/yellow-fg}\n\n{bold}{studio}{/bold}{/center}",
    CREDITS_SLIDE13:
      "{center}{yellow-fg}SPECIAL THANKS{/yellow-fg}\n\n{bold}{testers}{/bold}{/center}",
    CREDITS_SLIDE14:
      "{center}{yellow-fg}PROJECT LEAD{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_THANKS: "{center}{yellow-fg}THANK YOU FOR PLAYING{/yellow-fg}",
    CREDITS_COPYRIGHT:
      "{center}PALE LUNA DEVELOPER\n\n{year} © ALL RIGHTS RESERVED{/center}",
    ...
    OVERLAY_TOGGLE:
      "{yellow-fg}[SPACE]{/} Toggle | {yellow-fg}[ENTER]{/} Execute | {yellow-fg}[P]{/} Select All",
    ...
    PACPRO_WIN:
      "{center}{yellow-fg}{bold}ACCESS GRANTED{/}\n\nELITE PROTOCOL CLEARED\n\nREBOOTING SYSTEM...{/center}",
    PACPRO_LOSE:
      "{center}{red-fg}{bold}ACCESS DENIED{/}\n\nSUBSYSTEM FAILURE\n\nRESTARTING...{/center}",
    ...
    MAIN_ACHIEVEMENT_UNLOCKED:
      "{center}{yellow-fg}{bold}ACHIEVEMENT UNLOCKED{/}\n{white-fg}{name}{/center}",
    MAIN_CHECKPOINT_REACHED:
      "{center}{bold}CHECKPOINT REACHED{/}\n{white-fg}PROGRESS SAVED{/center}",
    MAIN_TIME_LABEL: "TIME",
    MAIN_BALANCE:
      "{green-fg}[SYSTEM]: Balance maintained. Neural link stable.{/green-fg}",
    MAIN_INSIDE:
      "[YOU]: I'm in. The system thinks I'm part of it. I can see the encrypted directories now.",
    MAIN_ENCRYPTION_PROMPT:
      "{center}ENTER ENCRYPTION KEY TO ACCESS 'PROJECT_FADE_1999_LOGS'\n\n{yellow-fg}(HINT: Check '[TOP_SECRET]' in the Main Menu){/yellow-fg}{/center}\n\n{center}DO NOT PRESS ESC{/}",
    MAIN_DECRYPTING:
      "{center}{green-fg}DECRYPTING... ACCESS GRANTED.{/green-fg}{/center}",
    MAIN_BREACH:
    ...
    MAIN_ENCRYPTION_FAIL:
      "INVALID ENCRYPTION KEY. The mainframe detected your intrusion and fried your neural path.",
    MAIN_SUBLEVEL:
      "[NARRATOR]: You step into the Heart of the LUX-4 Mainframe. The air is thick with static.",
    MAIN_ALARM:
      "{red-fg}[ALARM]: SECURITY BREACH. DOORS LOCKED. SELF-DESTRUCT IN 5 SECONDS.{/red-fg}",
    MAIN_LOCKDOWN:
      "{center}{bold}!!! SECURITY LOCKDOWN !!!{/bold}\n\nTYPE OVERRIDE CODE:\n\n{yellow-fg}{bold}{code}{/bold}{/yellow-fg}\n\nTIME: {time}s{/center}",
    MAIN_TIMEOUT: "TIME EXPIRED. The security system atomized the room.",
    MAIN_INVALID_CODE: "INVALID CODE. Internal defenses active.",
    MAIN_OVERRIDE_SUCCESS:
      "{center}{green-fg}OVERRIDE SUCCESSFUL. ACCESSING CORE...{/green-fg}{/center}",
    MAIN_ELITE_DATA:
      "{yellow-fg}[ELITE DATA UNLOCKED]: PROJECT FADE - PRELUDE TO 1999.{/yellow-fg}",
    MAIN_PRELUDE:
      "{yellow-fg}[PRELUDE]: 'The city didn't lose power in 1999. It was consumed to fuel the first upload.'{/yellow-fg}",
    MAIN_SYSTEM_DENIED:
      "[SYSTEM]: Administrative rights: DENIED. Manual core maintenance required.",
    MAIN_NARRATOR_ARMS:
      "[NARRATOR]: Mechanical arms emerge from the ceiling, forcing you into the Control Chair.",
    MAIN_SYSTEM_FLUCTUATION:
      "[SYSTEM]: Energy fluctuation detected. Initialize BALANCER.js to prevent blackout.",
    MAIN_CHAIR_LOCKED:
      "{center}CHAIR LOCKED. USER INTEGRATED.\n\nINITIALIZING BALANCER.js...{/center}",
    ...
    MAIN_FINAL_CHOICE_ELITE_1:
      "{yellow-fg}[ELITE LOG]: Credential PACPRO detected. Secret archive unlocked.{/yellow-fg}",
    MAIN_FINAL_CHOICE_ELITE_2:
      "{yellow-fg}[REPORT 1999]: 'The Fade wasn't a mistake. We found a way to live inside the electrons.'{/yellow-fg}",
    MAIN_FINAL_OVERRIDE: " TERMINAL OVERRIDE: PROJECT FADE ",
    MAIN_FINAL_PURGE: " > PURGE THE SYSTEM (Erase LUX-4/End the Fade) ",
    MAIN_FINAL_STABILIZE:
    ...
    MAIN_FINAL_PURGE_END:
      "You purged the core. The city went dark, but the cycle of the Fade was broken.",
    MAIN_FINAL_STABILIZE_TEXT: "[YOU]: I'll try to pull them back to reality.",
    MAIN_FINAL_STABILIZE_END:
      "You tried to stabilize the core. Thousands of digital ghosts returned, but you are now their silent guardian.",
    MAIN_FINAL_MERGE_TEXT:
      "[YOU]: The static is beautiful. I'm ready to evolve.",
    MAIN_FINAL_MERGE_END:
      "You merged with the core. You are no longer human. You are the LUX-4 Grid itself.",
    MAIN_CEO_WARNING:
      "{bold}{red-fg}! SYSTEM SECURITY ALERT !{/}\n\nThe system has detected a termination signal.\nYou have the choice to allow a {white-fg}REAL HARDWARE SHUTDOWN{/}.\nIf accepted, your PC will power off {yellow-fg}AFTER THE CREDITS{/}.\n\nDo you authorize this action?",
    MAIN_CEO_OVERRIDE: " OVERRIDE (NORMAL ENDING) ",
    MAIN_CEO_ACCEPT: " ACCEPT (SHUTDOWN AFTER CREDITS) ",
    MAIN_FINAL_MESSAGE:
      "You won, Operator. LUX-4 is gone, but the world is now in darkness.\nDo not return.\n- CEO",
    ...
    MAIN_ELEVATOR_MOTION:
      "{center}ELEVATOR IN MOTION...\n\nENTERTAINMENT SYSTEM ACTIVE.\nAWAITING PROCESS TERMINATION (Press F to exit game)...{/center}",
    MAIN_ELITE_LOG:
      "{yellow-fg}[ELITE LOG]: Credential PACPRO detected. Secret archive unlocked.{/yellow-fg}",
    MAIN_ELITE_CONGRATS:
      "{yellow-fg}[NON-CANNON]: You actually cleared the simulation. Respect, Operator. You are elite.{/yellow-fg}",
    MAIN_RADIO_SIGNAL:
      "[RADIO]: '...signal acquired. Tuning to 99.7 FM local news...'",
    MAIN_RADIO_STATEMENT:
      "[RADIO]: 'LUX-4 Energy Corp has issued a formal statement regarding the 1999 THE FADE incident...'",
    MAIN_RADIO_DENIAL:
      "[RADIO]: 'The board officially denies any involvement, claiming the reports of anomalies are baseless conspiracy theories...'",
    MAIN_RADIO_WARNING: "YOU KNOW TOO MUCH",
    MAIN_ELEVATOR_FAIL:
      "The power terminal was closed without releasing the protocols.",
    MAIN_ROOM_FAIL:
      "You wasted precious time. The room was flooded by shadows.",
    MAIN_SUBLEVEL_ARRIVAL1: "[SYSTEM]: *DING*",
    MAIN_SUBLEVEL_ARRIVAL2:
      "[SYSTEM]: ARRIVAL: SUBLEVEL 7 - RESEARCH AND DEVELOPMENT.",
    MAIN_SUBLEVEL_ARRIVAL3:
      "[NARRATOR]: The doors slide open. The basement is submerged in absolute silence.",
    MAIN_CORPORATE_ACCESS:
    ...
    MAIN_ADMIN_OVERRIDE:
      "{yellow-fg}ADMINISTRATIVE OVERRIDE DETECTED. HELLO, REBEL.{/yellow-fg}",
    MAIN_CREDENTIAL_FAIL:
      "FALSE OR CORRUPTED CREDENTIAL FILE. SECURITY TRIGGERED.",
    MAIN_ARRIVAL_WORK: " ARRIVAL AT WORK ",
    MAIN_ENTER_WORK: " 1. ENTER AND WORK ",
    MAIN_LEAVE_WORK: " 2. LEAVE AND ENJOY LIFE ",
    MAIN_LEAVE_END:
      "You chose life. As the world went dark, you felt peace for the first time.",
    MAIN_RANDOM: " 3. RANDOM (DECIDE BY LUCK) ",
    MAIN_RANDOM_END:
      "The die saved you. You turned your back on the building and went to enjoy the end.",
    MAIN_REPORT_DRIVE:
    ...
    SURVEY_RECOVERING:
      "{bold}[RECOVERING ARCHIVED TRANSMISSION: 09/11/1999]{/bold}",
    SURVEY_LINE: "--------------------------------------------------",
    SURVEY_OP1: "OP_06: Are you listening? The clock stopped at 00:00.",
    SURVEY_OP2:
      "OP_06: 'The Fade' was not a technical glitch. It was a cleanup.",
    SURVEY_OP3:
      "OP_06: In 1999, the world forgot how to breathe for 10 seconds.",
    ...
    PACPRO_HUD:
      "{center}LVL: {level}/3 | SCORE: {score} | FRAGMENTS: {dots}{/center}",
    ...
    PACPRO_GO_SCREEN:
      "{center}{red-fg}{bold}GAME OVER{/bold}{/red-fg}\n\n{reason}{/center}",
    ...
    ENERGIA_STATUS_DISPLAY:
      "{green-fg}ENERGY: {energia}%\nSANITY: {sanidade}%\nHEALTH: {saude}%\n\nPHASE: {passo}/5{/}",
    ...
    BALANCER_TIME:
      "{yellow-fg}STABILIZATION: {time}s | SHIFT IN: {shift}s{/yellow-fg}",
    BALANCER_MODE_BAR: "{center}MODE: BAR SYNC | [A/D] TO RECHARGE{/center}",
    BALANCER_MODE_PULSE:
      "{center}MODE: ENTER PULSE | [ENTER] ON THE HIT ZONE{/center}",
    BALANCER_MODE_HACK: "{center}MODE: KEY HACK | TYPE THE KEY{/center}",
    BALANCER_HACK_KEY:
      "{magenta-fg}{bold}SECURITY KEY: {key}{/bold}{/magenta-fg}",
    ...
    SUPPORT_ESC_RETURN: "\n\n{center}[ESC] TO RETURN{/center}",
    LANGUAGE_CHANGED:
      "{center}{bold}LANGUAGE CHANGED{/bold}\n\nThe system needs to reboot to apply the new linguistic protocols.{/center}",
    'MENU_DLCS': '{center}EXPANSIONS / DLCs{/center}',
    'DESC_DLCS': 'ACCESS ADDITIONAL CONTENT AND SYSTEM EXPANSIONS.',
    'DLC_EMPTY': '{center}\n{yellow-fg}NO DLCs DETECTED{/}\n\nVisit our store to acquire new operational modules.{/center}',
    'DLC_CHECKING': '{center}\n{yellow-fg}SCANNING REPOSITORY FOR EXPANSIONS...{/center}',
    'DLC_LIST_TITLE': ' [ AVAILABLE MODULES ] ',
    'DLC_DOWNLOAD': 'PRESS [ENTER] TO INSTALL MODULE | [ESC] RETURN',
    'DLC_INSTALLED': '{green-fg}[INSTALLED]{/green-fg}',
  },

  PT: {
    'MENU_DLCS': '{center}EXPANSÕES / DLCs{/center}',
    'DESC_DLCS': 'ACESSAR CONTEÚDO ADICIONAL E EXPANSÕES DO SISTEMA.',
    'DLC_EMPTY': '{center}\n{yellow-fg}NENHUMA DLC DETECTADA{/}\n\nAcesse a loja para adquirir novos módulos operacionais.{/center}',
    'DLC_CHECKING': '{center}\n{yellow-fg}ESCANEANDO REPOSITÓRIO POR EXPANSÕES...{/center}',
    'DLC_LIST_TITLE': ' [ MÓDULOS DISPONÍVEIS ] ',
    'DLC_DOWNLOAD': 'PRESSIONE [ENTER] PARA INSTALAR | [ESC] VOLTAR',
    'DLC_INSTALLED': '{green-fg}[INSTALADO]{/green-fg}',
    MENU_START: "{center}INICIAR O JOGO{/center}",
    MENU_CONTINUE: "{center}CONTINUAR MISSÃO{/center}",
    MENU_EXIT: "{center}SAIR{/center}",
    MENU_MINIGAME: "{center}MINIGAME{/center}",
    MENU_MINIGAME_NEW:
      "{center}{yellow-fg}MINIGAME (NOVO){/yellow-fg}{/center}",
    MENU_CHECKPOINTS: "{center}CHECKPOINTS{/center}",
    MENU_ACHIEVEMENTS: "{center}CONQUISTAS{/center}",
    MENU_ACCOUNT: "{center}CONTA GIHUB{/center}",
    MENU_SETTINGS: "{center}CONFIGURAÇÕES{/center}",
    MENU_UPDATES: "{center}ATUALIZAÇÕES{/center}",
    MENU_TOP_SECRET: "{center}[TOP_SECRET]{/center}",
    MENU_SUPPORT: "{center}APOIAR{/center}",
    MENU_CREDITS: "{center}CRÉDITOS{/center}",
    MENU_CLOSE: "{center}FECHAR{/center}",
    MENU_ERASE_DATA: "{center}APAGAR DADOS{/center}",
    MENU_RESET_TIME: "{center}REINICIAR TEMPO{/center}",
    MENU_INITIALIZING: "INICIALIZANDO",

    DESC_START: "INICIAR O PROTOCOLO OPERACIONAL PRIMÁRIO.",
    DESC_MINIGAME: "ACESSAR O SUBSISTEMA PACPRO DA SEQUÊNCIA DO ELEVADOR.",
    ...
    DESC_ACCOUNT: "VINCULAR CREDENCIAIS GITHUB PARA SINCRONIZAÇÃO NA NUVEM.",
    DESC_CHECKPOINTS: "VISUALIZAR TODOS OS PONTOS DE VERIFICAÇÃO RECUPERADOS.",
    DESC_SETTINGS: "CONFIGURAR ÁUDIO, COR, USUÁRIO E PARÂMETROS DE TELA.",
    DESC_ERASE: "ELIMINAR TODOS OS DADOS LOCAIS E CONFIGURAÇÕES.",
    ...
    DESC_SUPPORT: "CONTRIBUIR PARA O DESENVOLVIMENTO DO SISTEMA.",
    DESC_RESET_TIME: "ZERAR O CONTADOR DE TEMPO DE JOGO.",
    ...
    ACCOUNT_ONLINE:
      "{bold}STATUS DA CONTA: {green-fg}ONLINE (@{username}){/green-fg}{/bold}",
    ...
    ACCOUNT_STATS:
      "{center}{yellow-fg}ESTATÍSTICAS{/}\n{center}────────────────{/}\n{bold}VERSÃO:{/bold} {version}\n{bold}USUÁRIO:{/bold} {user}\n{bold}FRAGMENTOS:{/bold} {achs}/{total}\n\n {bold}ARMAZENAMENTO:{/bold} GIST",
    ACCOUNT_SOCIAL:
      "{cyan-fg}{bold}{name}{/}\n{bold}{grey-fg}@{login}{/}{/bold}\n\n{white-fg}{bio}{/}\n\n{bold}LOCAL:{/bold}  {location}\n{bold}SEGUIDORES:{/bold} {followers}\n{bold}GISTS:{/bold}     {gists}",
    ACCOUNT_SYNC: " SINCRONIZAR DADOS P/ NUVEM ",
    ACCOUNT_RESTORE: " RESTAURAR DADOS DA NUVEM ",
    ...
    SETTINGS_AUDIO: " ÁUDIO DO MENU: [{state}]",
    SETTINGS_EFFECTS: " EFEITOS SONOROS: [{state}]",
    SETTINGS_COLOR: " COR: [{color}]",
    SETTINGS_GLITCH: " LOGO GLITCH: [{state}]",
    SETTINGS_USERNAME: " USUÁRIO: [{username}]",
    ...
    SETTINGS_RESETS: " OPÇÕES DE RESET ",
    SETTINGS_BACK: " VOLTAR AO MENU ",
    LANGUAGE_CHANGED:
      "{center}{yellow-fg}IDIOMA ALTERADO{/}\n\nReininciando para aplicar todas as traduções.{/center}",

    FULLSCREEN_LOCKED:
      "{center}{red-fg}{bold}RECURSO BLOQUEADO{/bold}{/red-fg}\n\nTela cheia só está disponível via {bold}Windows Terminal{/bold}.\nO CMD antigo não suporta este protocolo.\n\n{yellow-fg}[ESC] PARA VOLTAR{/}",

    USERNAME_PROMPT: " [ DIGITE O NOME DE USUÁRIO ] ",

    STATUS_DISPLAY:
      " {bold}ÁUDIO:{/bold} {audio}\n\n {bold}COR:{/bold} {color}\n\n {bold}GLITCH:{/bold} {glitch} ",
    STATUS_ACTIVE: "{green-fg}ATIVO{/}",
    STATUS_MUTED: "{red-fg}MUDO{/}",

    SYSTEM_INFO_TITLE: " [ DADOS DO SISTEMA ] ",
    SYSTEM_INFO:
      " {bold}STATUS:{/bold}       {green-fg}{status}{/green-fg}\n {bold}SO:{/bold}           {os}\n {bold}VERSÃO:{/bold}      {version}\n {bold}USUÁRIO:{/bold}      {user}\n {bold}TERMINAL:{/bold}     {terminal}\n {bold}FRAGMENTOS:{/bold} {achievements}\n {bold}CHAVE:{/}   {key}\n\n [ESC] PARA VOLTAR",
    SYSTEM_INFO_OPERATIONAL: "OPERACIONAL",
    SYSTEM_ENCRYPTED:
      "\n{center}{yellow-fg}DADOS CRIPTOGRAFADOS{/}\n\nDIGITE O CÓDIGO DO DESENVOLVEDOR:{/center}\n{center}{green-fg}(DICA): ARQUIVOS RAIZ DO JOGO{/}{/}",
    SYSTEM_INVALID: "{red-fg}CÓDIGO INVÁLIDO. ACESSO NEGADO.{/}",

    SUPPORT_TITLE: " [ APOIAR O JOGO ] ",
    SUPPORT_INFO:
      "{bold}OBRIGADO POR APOIAR LIGHT!{/bold}\nSua contribuição ajuda a manter e expandir\na infraestrutura do sistema.\n\nEscolha uma ação:",
    SUPPORT_ITCH: "{center}DOAR NO ITCH.IO{/center}",
    SUPPORT_TWITTER: "{center}COMPARTILHAR{/center}",
    ...
    SUPPORT_AUDIO_INIT: "{center}Subsistema de áudio inicializado.{/center}",
    SUPPORT_ESC_RETURN: "\n\n{center}[ESC] PARA VOLTAR{/center}",

    ACHIEVEMENT_TOAST:
      "{center}{yellow-fg}{bold}FRAGMENTO ADQUIRIDO{/}\n{white-fg}{name}{/center}",
    ...
    ACHIEVEMENTS_HINT: '{center}PRESSIONE [H] OU CLIQUE EM "DICAS"{/center}',
    ACHIEVEMENTS_BUTTON: "{center}[H] VER DICAS{/center}",
    ACHIEVEMENTS_LOCKED:
      "{center}{white-fg}[ ] CORROMPIDO{/}\n\n{white-fg}DADOS BLOQUEADOS{/center}",
    ACHIEVEMENTS_UNLOCKED:
      "{center}{green-fg}{bold}[X] {name}{/}\n\n{white-fg}{desc}{/center}",
    ...
    ACHIEVEMENT_THE_END_DESC: "Alcançou a conclusão final.",
    ACHIEVEMENT_THE_END_HINT: "Chegue a qualquer um dos finais do jogo.",

    ACHIEVEMENT_NEVERMISS_NAME: "NUNCA ATRASADO",
    ACHIEVEMENT_NEVERMISS_DESC:
      "Completou todas as tarefas com tempo sobrando.",
    ACHIEVEMENT_NEVERMISS_HINT: "Seja extremamente rápido na rotina matinal.",

    ACHIEVEMENT_OVERRIDE_NAME: "INVASOR DE SISTEMAS",
    ACHIEVEMENT_OVERRIDE_DESC:
      "Acessou informações restritas dos desenvolvedores.",
    ACHIEVEMENT_OVERRIDE_HINT:
      "Use o código de desenvolvedor nas Informações do Sistema.",

    ACHIEVEMENT_REBEL_PATH_NAME: "OLÁ, REBELDE",
    ACHIEVEMENT_REBEL_PATH_DESC:
      "Usou o código de sobreposição administrativa.",
    ACHIEVEMENT_REBEL_PATH_HINT:
      "Digite um código alternativo no terminal de login do escritório.",

    ACHIEVEMENT_CEO_CONFRONT_NAME: "CENA DO DIRETOR",
    ACHIEVEMENT_CEO_CONFRONT_DESC: "Confrontou o CEO diretamente.",
    ACHIEVEMENT_CEO_CONFRONT_HINT: "Siga a rota secreta até a sala do CEO.",

    ACHIEVEMENT_TRUTH_SEEKER_NAME: "DECODIFICADOR",
    ACHIEVEMENT_TRUTH_SEEKER_DESC: "Decodificou os registros do Projeto Fade.",
    ACHIEVEMENT_TRUTH_SEEKER_HINT:
      "Encontre e use a chave de criptografia correta.",
    ...
    ACHIEVEMENT_GHOST_GUARDIAN_HINT:
      "Escolha proteger as almas no núcleo final.",

    ACHIEVEMENT_NEW_GOD_NAME: "ASCENSÃO ELETRÔNICA",
    ACHIEVEMENT_NEW_GOD_DESC:
      "Fundiu-se com o núcleo e tornou-se um com a rede.",
    ACHIEVEMENT_NEW_GOD_HINT: "Escolha se fundir com o Fade na escolha final.",

    ACHIEVEMENT_SHADOW_FALL_NAME: "MELTDOWN DO NÚCLEO",
    ACHIEVEMENT_SHADOW_FALL_DESC: "Falhou ao estabilizar o núcleo.",
    ACHIEVEMENT_SHADOW_FALL_HINT:
      "Falhe em manter o equilíbrio durante a sequência final.",

    ACHIEVEMENT_CITY_DARK_NAME: "APAGÃO TOTAL",
    ACHIEVEMENT_CITY_DARK_DESC: "Eliminou o sistema e encerrou o ciclo.",
    ACHIEVEMENT_CITY_DARK_HINT: "Escolha eliminar o núcleo na escolha final.",

    ACHIEVEMENT_SLOWTYPIST_NAME: "DIGITADOR LENTO",
    ACHIEVEMENT_SLOWTYPIST_DESC:
      "Deixou o timer da autodestruição chegar a zero.",
    ACHIEVEMENT_SLOWTYPIST_HINT:
      "Falhe em digitar o código de sobreposição a tempo.",

    ACHIEVEMENT_LEAK_SAVED_NAME: "DELATOR",
    ACHIEVEMENT_LEAK_SAVED_DESC: "Exportou os arquivos confidenciais.",
    ACHIEVEMENT_LEAK_SAVED_HINT:
      "Pressione [S] durante a sequência de vazamento de dados.",

    ACHIEVEMENT_TRUELIGHT_NAME: "A VERDADEIRA LUZ",
    ACHIEVEMENT_TRUELIGHT_DESC: "Desbloqueou todos os fragmentos do sistema.",
    ACHIEVEMENT_TRUELIGHT_HINT: "Desbloqueie todas as conquistas do jogo.",

    ACHIEVEMENT_AUDIOPHOBIC_NAME: "AUDIOFÓBICO",
    ACHIEVEMENT_AUDIOPHOBIC_DESC: "Desativou o sistema de áudio cinco vezes.",
    ACHIEVEMENT_AUDIOPHOBIC_HINT:
      "Pressione [M] cinco vezes para mutar o áudio.",

    ACHIEVEMENT_COLOR_MASTER_NAME: "ANALISTA ESPECTRAL",
    ACHIEVEMENT_COLOR_MASTER_DESC:
      "Alternou entre todas as cores do sistema repetidamente.",
    ACHIEVEMENT_COLOR_MASTER_HINT: "Pressione [C] quinze vezes em uma sessão.",

    ACHIEVEMENT_RARE_BOOT_NAME: "ANOMALIA DO SISTEMA",
    ACHIEVEMENT_RARE_BOOT_DESC: "Ativou a rara sequência de inicialização.",
    ACHIEVEMENT_RARE_BOOT_HINT:
      "O sistema às vezes mostra sua verdadeira face.",

    ACHIEVEMENT_DATA_MINER_NAME: "MINERADOR DE DADOS",
    ACHIEVEMENT_DATA_MINER_DESC:
      "Acessou informações do sistema obsessivamente.",
    ACHIEVEMENT_DATA_MINER_HINT:
      "Abra as Informações do Sistema dez vezes em uma sessão.",
    ...
    ACHIEVEMENT_TERMINAL_JUNKIE_HINT:
      "Entre e saia da tela de conquistas cinco vezes.",

    ACHIEVEMENT_HARD_RESET_NAME: "RECOMEÇO",
    ACHIEVEMENT_HARD_RESET_DESC:
      "Resetou todas as configurações para o padrão.",
    ACHIEVEMENT_HARD_RESET_HINT:
      "Use a opção Restaurar Padrões nas Configurações.",

    RARE_BOOT_UNLOCKED:
      "{center}\n{yellow-fg}{bold}ANOMALIA DETECTADA{/bold}{/}\n\nA rara sequência de inicialização foi\npermanentemente sincronizada.\n\n{white-fg}Este protocolo agora é seu padrão.{/}\n\n{cyan-fg}[ENTER] PARA CONTINUAR{/center}",

    UPDATE_TITLE: "{center}\nCONECTANDO AO REPOSITÓRIO...{/center}",
    UPDATE_MAPPING:
      "{center}\n{yellow-fg}MAPEANDO REPOSITÓRIO...{/}\nEstabelecendo link seguro via PowerShell.{/center}",
    UPDATE_INSTALLING:
      "{center}\n{yellow-fg}INSTALANDO ATUALIZAÇÃO...{/}\n\nVersão: {version}\n\n[{bar}] {percentage}%\n\n{white-fg}Não feche o aplicativo.{/white-fg}{/center}",
    UPDATE_SECTOR:
      "{center}{grey-fg}{bold}Setor {current} de {total} | Sincronizando: {file}{/bold}{/grey-fg}{/center}",
    UPDATE_COMPLETE_MSG:
      "{center}{bold}SEQUÊNCIA DE ATUALIZAÇÃO CONCLUÍDA{/bold}{/center}",
    UPDATE_COMPLETE:
    ...
    UPDATE_CURRENT:
      "{center}\n{green-fg}SISTEMA ATUALIZADO{/green-fg}\n\nVersão {version} é a mais recente.{/center}\n\n\n\n\n{center}{bold}{grey-fg}[ESC] PARA FECHAR{/grey-fg}{/bold}{/center}",

    RESET_OPTIONS: " [ REINICIALIZAÇÃO ] ",
    RESET_DATA: " REINICIAR TODOS OS DADOS",
    RESET_PLAYTIME: " REINICIAR TEMPO DE JOGO",
    RESET_CONFIGS: " REINICIAR CONFIGURAÇÕES",
    RESET_BACK: " VOLTAR",
    ...
    ERASE_COMPLETE: "{center}\n\n\n{bold}LIMPEZA CONCLUÍDA{/}{/center}",

    TIME_RESET_TITLE: " [ REINICIALIZAÇÃO TEMPORAL ] ",
    TIME_CURRENT: "{center}{cyan-fg}ATUAL: {time}{/}{/center}",
    TIME_YES: "{center}SIM, REINICIAR{/center}",
    TIME_NO: "{center}NÃO, ABORTAR{/center}",
    TIME_SYNCING: " [ SINCRONIZANDO VETORES TEMPORAIS ] ",
    TIME_REWINDING: "{cyan-fg}[REBOBINANDO]{/}",
    TIME_DELETED: "{bold}DELETADO{/}",
    TIME_COMPLETE:
      "{center}\n\n\n{bold}VETORES REESTABELECIDOS{/}\n{green-fg}RELÓGIO ZERADO{/}{/center}",
    TIME_PURGED: "{yellow-fg}Tempo de jogo foi reiniciado.{/}",

    CHECKPOINT_HEADER:
      "{center}{bold}PONTOS DE VERIFICAÇÃO: {current}/{total}{/center}",
    CHECKPOINT_REACHED:
      "{center}{green-fg}{bold}[X] {name}{/}\n\n{white-fg}{desc}{/center}",
    CHECKPOINT_LOCKED:
    ...
    CREDITS_SLIDE2:
      "{center}{yellow-fg}UMA HISTÓRIA ORIGINAL DE{/yellow-fg}\n\n{bold}LUCAS EDUARDO{/bold}{/center}",
    CREDITS_SLIDE3:
      "{center}{yellow-fg}DIRETOR{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE4:
      "{center}{yellow-fg}PROGRAMADOR PRINCIPAL{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE5:
      "{center}{yellow-fg}ARQUITETO DO SISTEMA{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE6:
      "{center}{yellow-fg}DESIGN VISUAL{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE7:
      "{center}{yellow-fg}DESIGN DE NÍVEIS{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE8:
      "{center}{yellow-fg}DESIGN NARRATIVO{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE9:
      "{center}{yellow-fg}ENGENHARIA DE ÁUDIO{/yellow-fg}\n\n{bold}{names}{/bold}{/center}",
    CREDITS_SLIDE10:
      "{center}{yellow-fg}GARANTIA DE QUALIDADE{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    CREDITS_SLIDE11:
      "{center}{yellow-fg}TEMA DE ENCERRAMENTO{/yellow-fg}\n\n{bold}{theme}{/bold}{/center}",
    CREDITS_SLIDE12:
      "{center}{yellow-fg}PUBLICADOR{/yellow-fg}\n\n{bold}{studio}{/bold}{/center}",
    CREDITS_SLIDE13:
      "{center}{yellow-fg}AGRADECIMENTOS ESPECIAIS{/yellow-fg}\n\n{bold}{testers}{/bold}{/center}",
    CREDITS_SLIDE14:
      "{center}{yellow-fg}LÍDER DE PROJETO{/yellow-fg}\n\n{bold}{name}{/bold}{/center}",
    ...
    CREDITS_REPLAY: "{center}REVER CRÉDITOS{/center}",
    CREDITS_SKIP: "{grey-fg}{bold}[ESC] PARA PULAR{/grey-fg}{/}",
    CREDITS_FINAL_TITLE: " [ SESSÃO FINALIZADA ] ",
    CREDITS_QUICK_ACTIONS: "[ AÇÕES RÁPIDAS ]",

    OVERLAY_TITLE: " [ SOBREPOSIÇÃO ] ",
    OVERLAY_MESSAGE:
      "{center}\n{bold}SOBREPOSIÇÃO ADMINISTRATIVA{/bold}\n\nIsso ignorará a criptografia e desbloqueará\nsetores de dados selecionados.\n\n{yellow-fg}[ENTER]{/} PROSSEGUIR | {white-fg}[ESC]{/} ABORTAR{/center}",
    OVERLAY_SELECT: " [ SELECIONAR SETORES ] ",
    OVERLAY_TOGGLE:
      "{yellow-fg}[ESPAÇO]{/} Alternar | {yellow-fg}[ENTER]{/} Executar | {yellow-fg}[P]{/} Selecionar Tudo",
    ...
    PACPRO_WIN:
      "{center}{yellow-fg}{bold}ACESSO CONCEDIDO{/}\n\nPROTOCOLO ELITE LIBERADO\n\nREINICIANDO SISTEMA...{/center}",
    PACPRO_LOSE:
      "{center}{red-fg}{bold}ACESSO NEGADO{/}\n\nFALHA NO SUBSISTEMA\n\nREINICIANDO...{/center}",
    ...
    MAIN_ACHIEVEMENT_UNLOCKED:
      "{center}{yellow-fg}{bold}CONQUISTA DESBLOQUEADA{/}\n{white-fg}{name}{/center}",
    MAIN_CHECKPOINT_REACHED:
      "{center}{bold}PONTO DE VERIFICAÇÃO ALCANÇADO{/}\n{white-fg}PROGRESSO SALVO{/center}",
    MAIN_TIME_LABEL: "TEMPO",
    MAIN_BALANCE:
      "{green-fg}[SISTEMA]: Equilíbrio mantido. Link neural estável.{/green-fg}",
    MAIN_INSIDE:
      "[VOCÊ]: Estou dentro. O sistema pensa que sou parte dele. Agora vejo os diretórios criptografados.",
    MAIN_ENCRYPTION_PROMPT:
      "{center}DIGITE A CHAVE DE CRIPTOGRAFIA PARA ACESSAR 'PROJECT_FADE_1999_LOGS'\n\n{yellow-fg}(DICA: Verifique '[TOP_SECRET]' no Menu Principal){/yellow-fg}{/center}\n\n{center}NÃO PRESSIONE ESC{/}",
    MAIN_DECRYPTING:
      "{center}{green-fg}DECODIFICANDO... ACESSO CONCEDIDO.{/green-fg}{/center}",
    MAIN_BREACH:
      "{center}{yellow-fg}{bold}ATENÇÃO: VIOLAÇÃO DE DADOS BEM-SUCEDIDA{/bold}{/yellow-fg}\n\nOs arquivos confidenciais foram expostos.\nSe você salvou o vazamento [S], verifique sua {white-fg}ÁREA DE TRABALHO{/white-fg} por 'LUX_CONFIDENTIAL.txt'.\nHá um código de bypass escondido dentro desse arquivo.\n\n\n\n\n{blink}PRESSIONE [ENTER] PARA CONTINUAR.{/blink}{/center}",
    MAIN_ENCRYPTION_FAIL:
      "CHAVE INVÁLIDA. O sistema detectou sua intrusão e fritou seu caminho neural.",
    MAIN_SUBLEVEL:
      "[NARRADOR]: Você entra no Coração do Mainframe LUX-4. O ar está denso com estática.",
    MAIN_ALARM:
      "{red-fg}[ALARME]: VIOLAÇÃO DE SEGURANÇA. PORTAS TRANCADAS. AUTODESTRUIÇÃO EM 5 SEGUNDOS.{/red-fg}",
    MAIN_LOCKDOWN:
      "{center}{bold}!!! SEGURANÇA BLOQUEADA !!!{/bold}\n\nDIGITE O CÓDIGO DE SOBREPOSIÇÃO:\n\n{yellow-fg}{bold}{code}{/bold}{/yellow-fg}\n\nTEMPO: {time}s{/center}",
    ...
    MAIN_OVERRIDE_SUCCESS:
      "{center}{green-fg}SOBREPOSIÇÃO BEM-SUCEDIDA. ACESSANDO O NÚCLEO...{/green-fg}{/center}",
    MAIN_ELITE_DATA:
      "{yellow-fg}[DADOS DE ELITE DESBLOQUEADOS]: PROJECT FADE - PRELÚDIO PARA 1999.{/yellow-fg}",
    MAIN_PRELUDE:
      "{yellow-fg}[PRELÚDIO]: 'A cidade não perdeu a energia em 1999. Ela foi consumida para alimentar o primeiro upload.'{/yellow-fg}",
    MAIN_SYSTEM_DENIED:
      "[SISTEMA]: Direitos administrativos: NEGADOS. Manutenção manual do núcleo necessária.",
    MAIN_NARRATOR_ARMS:
      "[NARRADOR]: Braços mecânicos emergem do teto, forçando você na Cadeira de Controle.",
    MAIN_SYSTEM_FLUCTUATION:
      "[SISTEMA]: Flutuação de energia detectada. Inicialize BALANCER.js para prevenir queda de energia.",
    MAIN_CHAIR_LOCKED:
      "{center}CADEIRA TRAVADA. USUÁRIO INTEGRADO.\n\nINICIALIZANDO BALANCER.js...{/center}",
    MAIN_CORE_EXPLODED: "O núcleo explodiu. O Fade consumiu a realidade.",
    MAIN_FINAL_CHOICE_1:
      "[SISTEMA]: Conexão com o núcleo estável. A luz violeta do Fade pulsa diante de você.",
    MAIN_FINAL_CHOICE_2: "[VOCÊ]: É isso. O núcleo digitalizador da LUX-4.",
    MAIN_FINAL_CHOICE_ELITE_1:
      "{yellow-fg}[LOG DE ELITE]: Credencial PACPRO detectada. Arquivo secreto desbloqueado.{/yellow-fg}",
    MAIN_FINAL_CHOICE_ELITE_2:
      "{yellow-fg}[RELATÓRIO 1999]: 'O Fade não foi um erro. Encontramos uma maneira de viver dentro dos elétrons.'{/yellow-fg}",
    ...
    MAIN_FINAL_STABILIZE:
      " > ESTABILIZAR O FADE (Tentar resgatar as almas presas) ",
    MAIN_FINAL_MERGE:
      " > FUNDIR-SE COM O FADE (Tornar-se o novo Deus da Rede) ",
    MAIN_FINAL_PURGE_TEXT: "[VOCÊ]: Este experimento termina agora. Por todos.",
    MAIN_FINAL_PURGE_END:
      "Você eliminou o núcleo. A cidade ficou escura, mas o ciclo do Fade foi quebrado.",
    MAIN_FINAL_STABILIZE_TEXT:
      "[VOCÊ]: Vou tentar trazê-los de volta à realidade.",
    MAIN_FINAL_STABILIZE_END:
      "Você tentou estabilizar o núcleo. Milhares de fantasmas digitais retornaram, mas agora você é seu guardião silencioso.",
    MAIN_FINAL_MERGE_TEXT:
      "[VOCÊ]: A estática é linda. Estou pronto para evoluir.",
    MAIN_FINAL_MERGE_END:
      "Você se fundiu com o núcleo. Você não é mais humano. Você é a própria Rede LUX-4.",
    MAIN_CEO_WARNING:
      "{bold}{red-fg}! ALERTA DE SEGURANÇA DO SISTEMA !{/}\n\nO sistema detectou um sinal de término.\nVocê tem a escolha de permitir um {white-fg}DESLIGAMENTO REAL DE HARDWARE{/}.\nSe aceito, seu PC será desligado {yellow-fg}APÓS OS CRÉDITOS{/}.\n\nVocê autoriza esta ação?",
    MAIN_CEO_OVERRIDE: " SOBREPOSIÇÃO (FINAL NORMAL) ",
    MAIN_CEO_ACCEPT: " ACEITAR (DESLIGAR APÓS CRÉDITOS) ",
    MAIN_FINAL_MESSAGE:
      "Você venceu, Operador. A LUX-4 se foi, mas o mundo agora está na escuridão.\nNão volte.\n- CEO",
    MAIN_OFFICE_SCENE1: "[SISTEMA]: Você entra no prédio. O ar é pesado.",
    MAIN_OFFICE_SCENE2:
      "[CAOS]: Colegas de trabalho estão correndo em círculos, alguns rezando, outros quebrando monitores.",
    MAIN_OFFICE_SCENE3:
      "[DESESPERO]: 'A LUZ NÃO VAI VOLTAR!', a recepcionista grita enquanto seus olhos sangram sombras.",
    MAIN_OFFICE_SCENE4: "[MISSÃO]: Você ignora os gritos e corre para o porão.",
    MAIN_OFFICE_SCENE5:
      "[LOCALIZADO]: Você avista uma placa de metal escovado: 'SALA DE GESTÃO DE ENERGIA'.",
    MAIN_OFFICE_FOCUS:
    ...
    MAIN_SIT_SYSTEM:
      "[SISTEMA]: Você se senta na cadeira. O terminal à sua frente pisca em verde...",
    MAIN_POWER_ON: " > LIGAR TERMINAL ",
    MAIN_DESTROY: " > DESTRUIR TERMINAL ",
    MAIN_DESTROY_END:
      "Você destruiu a última esperança de luz. A escuridão te consumiu.",
    MAIN_ELEVATOR_UNLOCK:
      "{center}SISTEMA INICIADO EM SEGUNDA INSTÂNCIA.\nAGUARDANDO SEQUÊNCIA DE DESTRAVAMENTO DO ELEVADOR...{/center}",
    MAIN_ELEVATOR_SCENE1:
      "[SISTEMA]: O terminal fica escuro. Um barulho alto ecoa no fim do corredor.",
    MAIN_ELEVATOR_SCENE2:
    ...
    MAIN_ELEVATOR_SCENE4:
      "[NARRADOR]: Você entra no elevador espelhado. O ar é frio.",
    MAIN_ELEVATOR_SCENE5:
      "[SISTEMA]: DESCIDA INICIADA. ESCOLHA ATIVIDADE DA INTERFACE DA CABINE.",
    MAIN_ELEVATOR_INTERFACE: " INTERFACE DO ELEVADOR ",
    MAIN_PLAY_PACPRO: " 1. JOGAR PACPRO (Subsistema) ",
    MAIN_LISTEN_RADIO: " 2. OUVIR RÁDIO LOCAL ",
    MAIN_ELEVATOR_MOTION:
      "{center}ELEVADOR EM MOVIMENTO...\n\nSISTEMA DE ENTRETENIMENTO ATIVO.\nAGUARDANDO TÉRMINO DO PROCESSO (Pressione F para sair do jogo)...{/center}",
    MAIN_ELITE_LOG:
      "{yellow-fg}[LOG DE ELITE]: Credencial PACPRO detectada. Arquivo secreto desbloqueado.{/yellow-fg}",
    MAIN_ELITE_CONGRATS:
      "{yellow-fg}[NÃO-CANÔNICO]: Você realmente zerou a simulação. Respeito, Operador. Você é elite.{/yellow-fg}",
    MAIN_RADIO_SIGNAL:
      "[RÁDIO]: '...sinal adquirido. Sintonizando 99.7 FM notícias locais...'",
    MAIN_RADIO_STATEMENT:
      "[RÁDIO]: 'A LUX-4 Energy Corp emitiu uma declaração oficial sobre o incidente de 1999, THE FADE...'",
    MAIN_RADIO_DENIAL:
      "[RÁDIO]: 'O conselho nega oficialmente qualquer envolvimento, alegando que os relatos de anomalias são teorias da conspiração infundadas...'",
    MAIN_RADIO_WARNING: "VOCÊ SABE DEMAIS",
    MAIN_ELEVATOR_FAIL:
      "O terminal de energia foi fechado sem liberar os protocolos.",
    MAIN_ROOM_FAIL:
      "Você perdeu tempo precioso. A sala foi inundada por sombras.",
    MAIN_SUBLEVEL_ARRIVAL1: "[SISTEMA]: *DING*",
    MAIN_SUBLEVEL_ARRIVAL2:
      "[SISTEMA]: CHEGADA: SUBLEVEL 7 - PESQUISA E DESENVOLVIMENTO.",
    MAIN_SUBLEVEL_ARRIVAL3:
      "[NARRADOR]: As portas se abrem. O porão está submerso em silêncio absoluto.",
    MAIN_CORPORATE_ACCESS:
    ...
    MAIN_ADMIN_OVERRIDE:
      "{yellow-fg}SOBREPOSIÇÃO ADMINISTRATIVA DETECTADA. OLÁ, REBELDE.{/yellow-fg}",
    MAIN_CREDENTIAL_FAIL:
      "ARQUIVO DE CREDENCIAIS FALSO OU CORROMPIDO. SEGURANÇA ACIONADA.",
    MAIN_ARRIVAL_WORK: " CHEGADA AO TRABALHO ",
    MAIN_ENTER_WORK: " 1. ENTRAR E TRABALHAR ",
    MAIN_LEAVE_WORK: " 2. SAIR E APROVEITAR A VIDA ",
    MAIN_LEAVE_END:
      "Você escolheu a vida. Enquanto o mundo escurecia, você sentiu paz pela primeira vez.",
    MAIN_RANDOM: " 3. ALEATÓRIO (DECIDIR POR SORTE) ",
    MAIN_RANDOM_END:
      "O dado te salvou. Você virou as costas para o prédio e foi aproveitar o fim.",
    MAIN_REPORT_DRIVE:
      "[RELATO]: Você dirige pelas ruas... o asfalto parece absorver os faróis.",
    MAIN_OBSERVATION:
      "[OBSERVAÇÃO]: Você vê um acidente de carro brutal. As vítimas apenas encaram o céu escuro.",
    MAIN_WORLD:
      "[MUNDO]: Prédios inteiros estão perdendo a cor, se tornando cinza estático.",
    MAIN_CHAOS:
      "[CAOS]: O céu às 7:00 da manhã é tão preto quanto o fundo de um poço.",
    MAIN_NARRATOR_PARK:
      "[NARRADOR]: Você finalmente estaciona em frente ao bloco do escritório.",
    ...
    MAIN_TASK_UNIFORM: " 2. Vestir o uniforme de trabalho ",
    ...
    MAIN_GAME_OVER_LATE: "O TEMPO ACABOU. VOCÊ CHEGOU ATRASADO NO TRABALHO.",
    MAIN_NARRATIVE1: "[NARRADOR]: Você acorda na sua cama...",
    MAIN_NARRATIVE2:
      "[NARRADOR]: O mundo parece estar 'desbotando' ao seu redor...",
    MAIN_NARRATIVE3:
      "[VOCÊ]: Que estranho, os prédios parecem mais escuros... talvez seja coisa da minha cabeça.",
    MAIN_NARRATIVE4:
    ...
    MAIN_FADE_SYNCED:
      "{center}{bold}MEMÓRIA DE 1999 SINCRONIZADA.{/bold}\n\nVOCÊ AGORA É PARTE DO FADE.\nSISTEMA EM CONFLITO.\n\n{blink}Pressione [ENTER] para limpar o cache e tentar o Questionário novamente...{/blink}{/center}",
    MAIN_AUTH_FAILED: "FALHA NA AUTENTICAÇÃO.",
    MAIN_CONNECTION_LOST:
      "CONEXÃO PERDIDA: O terminal do questionário foi fechado abruptamente.",
    MAIN_MENU_START: " INICIAR NOVO QUESTIONÁRIO ",
    ...
    PACPRO_HUD: "NVL: {level}/3 | PONTOS: {score} | FRAG: {dots}",
    ...
    PACPRO_GO_SCREEN:
      "{center}{red-fg}{bold}FIM DE JOGO{/bold}{/red-fg}\n\n{reason}{/center}",

    ENERGIA_LOG: " LOG DO SISTEMA ",
    ...
    ENERGIA_INVALID_KEY: "CHAVE INVÁLIDA",
    ENERGIA_GAME_OVER:
      "{center}{red-fg}{bold}FIM DE JOGO{/bold}{/red-fg}\n\n{reason}{/center}",
    ...
    BALANCER_TIME:
      "{yellow-fg}ESTABILIZAÇÃO: {time}s | MUDANÇA EM: {shift}s{/yellow-fg}",
    BALANCER_MODE_BAR:
      "{center}MODO: SINCRONIA DE BARRA | [A/D] PARA RECARREGAR{/center}",
    BALANCER_MODE_PULSE:
      "{center}MODO: PULSO DE ENTRADA | [ENTER] NA ZONA DE ACERTO{/center}",
    BALANCER_MODE_HACK:
      "{center}MODO: INVASÃO DE TECLA | DIGITE A TECLA{/center}",
    BALANCER_HACK_KEY:
      "{magenta-fg}{bold}CHAVE DE SEGURANÇA: {key}{/bold}{/magenta-fg}",
    BALANCER_PULSE_TITLE: " PULSO DE SINCRONIA ",
    BALANCER_PULSE_ZONE: "{black-fg} ACERTE {/black-fg}",
    BALANCER_WARNING:
      "{center}\n{yellow-fg}{bold}AVISO DE INTERAÇÃO DO SISTEMA{/}\n\nEste software foi projetado para modificar arquivos locais.\nUm arquivo de sucesso será gerado após a estabilização.\n\n{blink}PRESSIONE [ENTER] PARA CONFIRMAR{/}{/center}",
    BALANCER_SUCCESS:
      "{green-fg}{bold}MISSÃO BEM-SUCEDIDA{/}\nNÚCLEO ESTABILIZADO",
    BALANCER_GAME_OVER:
      "{center}{red-fg}{bold}FIM DE JOGO{/bold}{/red-fg}\n\n{reason}{/center}",
